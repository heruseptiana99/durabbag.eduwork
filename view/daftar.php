    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col text-center align-self-center">
                <img src="../assets/image/tampilan/bag1.png" width="600px">
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <h4>DAFTAR | DURABBAG</h4>
                        </div>
                        ...
                        <div class="mb-3">
                            <small for="">Sudah punya akun? <a href="masuk.php">Klik disini!</a></small>
                        </div>
                        <div class="mb-3">
                            <button id="my-button" type="button" class="btn btn-dark">DAFTAR</button>
                        </div>
                        </form>
